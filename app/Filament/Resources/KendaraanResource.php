...
class KendaraanResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('kendaraan_id')->label('Kendaraan ID')->alignCenter(),
                Tables\Columns\TextColumn::make('no_polisi')->label('No Polisi')->alignCenter(),
                Tables\Columns\TextColumn::make('golongan')->label('Golongan')->alignCenter(),
                Tables\Columns\TextColumn::make('tinggi_kendaraan')->label('Tinggi (m)')->alignCenter(),
                Tables\Columns\TextColumn::make('jenis_kendaraan')->label('Jenis Kendaraan')->alignCenter(),
            ])
            ->filters([
